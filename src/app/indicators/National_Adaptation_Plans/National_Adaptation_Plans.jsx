        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-white p-4">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 text-sm sm:text-lg">Loading NAP data...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 sm:mb-8">
                        ...
                        <div className="text-left sm:text-right">
                            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">NAP Analytics Dashboard</h1>
                            <p className="text-sm sm:text-base text-gray-600">National Adaptation Plans</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-4 sm:mb-8">
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border-2 border-purple-200">
                            ...
                            <p className="text-xs sm:text-sm text-gray-600 font-medium">NAP Sources</p>
                        </div>
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-lg mb-4 sm:mb-8">
                        <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-xs sm:text-sm text-gray-600">Distribution across NAP documents</p>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className="min-w-0">
                                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">National Adaptation Plans</h1>
                                <p className="text-gray-600 text-xs sm:text-sm mt-0.5 sm:mt-1">Explore climate adaptation indicators from NAPs</p>
                            </div>
                        </div>
                ...
                {!selectedSource ? (
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-blue-100">
                        <div className="mb-4 sm:mb-6 text-center">
                            ...
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1 sm:mb-2">Select NAP Source</h2>
